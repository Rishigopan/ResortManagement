    ...
    <body>
        ...
        <main id="main" class="main">
            <div class="container-fluid">
                <h4 class="d-flex justify-content-center py-1 contitle">IP Patient Records Show</h4>   
            </div>        
                                ...
                                <div class="row">
                                        <div class="col-xl-6 col-lg-6 col-12">
                                            ...
                                            <div class="12">
                                                ...
                                                <input type="date" class="form-control mt-1 inputfield Date" id="date" name="Date" value="{{$key->date}}"  disabled>
                                            </div>
                                            <div class="12">
                                            ...
                                            @foreach ($gpe as $genexam )
                                                @if ($genexam->input_type == 'check')
                                                    @foreach($jsonresult as $jsonresults)
                                                        ...
                                                        @endif
                                                    @endforeach
                                                    <input class="form-check-input patientrec" type="checkbox" value="" id="check{{$genexam->id}}" name="{{$genexam->name}}" disabled data-records="{{$genexam->id}}" @if($Value == '1') checked @endif >                                      
