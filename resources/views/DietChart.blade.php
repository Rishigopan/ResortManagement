    ...
    <body>
        ...
        <main id="main" class="main">
            ...
            <div class="container-fluid">
                <h4 class="d-flex justify-content-center py-1 contitle">Diet Chart</h4>                                                                  
            </div>                    
            <div class="wrapper">
                <!--CONTENTS-->
                <div class="container-fluid mainContents">
                    <form id="dietchart" class="AddForm"> 
                        ...
                        <div class="col-xl-3 col-lg-3 col-12">
                            ...
                            <div class="col-xl-3 col-lg-3 col-12">
                                ...
                                <input type="date" class="form-control  inputfield" aria-label="Default select example name" id="date" name="Date" value="<?php echo date('Y-m-d'); ?>" min="<?php echo date("Y-m-d"); ?>" required>
                            </div> 
                            <div class="col-xl-3 col-lg-3 col-12">
                            ...
                            <div class="col-xl-6 col-lg-6 col-12">
                                <label class=" mb-1 inputlabel">Diet<span  style="color:red"> *</span></label><br>
                                <select class="inputfield dietselect multiselect" multiple aria-label="Default select example name"id="diet" name="Diet" required>
                    ...
                    <form id="update_diet_chart" class="UpdateForm" style="display: none;">                                                       
                        ...
                        <div class="row mx-2">
                            ...
                            <div class="col-xl-3 col-lg-3 col-12">
                                <label class=" mb-1 inputlabel">Op Number<span  style="color:red"> *</span></label><br>
                                <select class="SearchAndSelect inputfield op_no" aria-label="Default select example name"id="update_op_no" name="UpdateOPNo">
                                    @foreach ($opno as $key )   
                                        <option class="inputlabel" value="{{$key->id}}">{{$key->op_no}} </option>
                                    @endforeach                                 
                                </select>
                            ...
                            <div class="col-xl-3 col-lg-3 col-12">
                                <label class=" mb-1 inputlabel">Date<span  style="color:red"> *</span></label><br>
                                <input type="date" class="form-control mt-1 inputfield" id="update_date" name="UpdateDate" autofocus required>
                            </div> 
                            <div class="col-xl-3 col-lg-3 col-12">
                                <label class=" mb-1 inputlabel">Time<span  style="color:red"> *</span></label><br>
        ...
        <script type="text/javascript">
            ...
            $(document).on('click','.op_no',(function(){
            ...
            var MasterTable = $('.MasterTable').DataTable({
                ...
                ajax: "{{ route('DietChart.dietchart') }}",
                columns: [
            ...
            function addDietToCard() {
                ...
                for (var i = 0; i < DietList.length; i++) {
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-6 p-1" data-task-id="${Diets.id}">
                        <div class="Dietcard">
                        <div class="p-2">
                            <h6 class="Dietcharts"><b>${Diets.OPName}</b></h6> 
            ...
            //Diet array
            function addDiets() {
                const DietChartOpname = $('#op_no option:selected').text();
                const DietChartOpNo = $('#op_no').val();
            ...
            $('#MasterTable').on('click', '.btn_edit', function () {
                ...
                var settings = {
                    "url": "/api/dietchart/"+EditDietChart+"",
                    "method": "GET",
                    "timeout": 0,
                };
                $.ajax(settings).done(function (response) {
                    ...
                    if (Dietchartedit.success == true) {
                        ...
                        var DietDataArray = Dietchartedit.dietchats;
                        for(const key in DietDataArray){
                            var DietOpNo = DietDataArray['op_no_id'];
                        ...
                        $('#update_op_no').data('selectize').setValue(DietOpNo);
            ...
            $("#update_diet_chart").validate({
                ...
                submitHandler: function(form) {
                    var UpdateDietChartOpNo = $('#update_op_no').val();
            ...
            $('#MasterTable').on('click', '.btn_delete', function () {
                ...
                $('#confirmYes').click(function(){
                    ...
                    $.ajax({
                        url: "/api/dietchart/"+DeleteDietChart+"",
                        method: "DELETE",
                        timeout: 0,
                        headers: {
                        "Accept": "application/json",
