    ...
    <body>
                    ...
                    <form id="dietchart" class="AddForm"> 
                     {{ csrf_field() }}                                                     
                        ...
                        <div class="col-xl-3 col-lg-3 col-12">
                            ...
                            <div class="col-xl-3 col-lg-3 col-12">
                                <label class="mt-2 inputlabel inputlabel">Date<span  style="color:red"> *</span></label><br>
        ...
        <script type="text/javascript">
            ...
            var MasterTable = $('.MasterTable').DataTable({
                ...
                ajax: "{{ route('DietCharts.dietcharts', ['id' => $id, 'op_id' => $op_id]) }}",
                columns: [
            ...
            $('#MasterTable').on('click', '.btn_edit', function () {
                ...
                $.ajax(settings).done(function (response) {
                    ...
                    if (Dietchartedit.success == true) {
                        ...
                        $("#update_op_no").val(DietOpNo).change();
...
//                    console.log(UpdateDietChartDietId);
