    ...
    <body> 
                    ...
                    <form id="update_diet_chart" class="UpdateForm" style="display: none;">                                                       
                        ...
                        <div class="row mx-2">
                            ...
                            <div class="col-xl-6 col-lg-6 col-12">
                                ...
                                <select class="inputfield updietselect multiselect" aria-label="Default select example name" multiple id="update_diet" name="UpdateDiet"required>
                                    <option hidden value=""> Choose Diet</option>
                                    @foreach ($diet as $key )   
                                        <option class="inputlabel" value="{{$key->id}}">{{$key->name}} </option>                
                                    @endforeach                                 
        ...
        <script type="text/javascript">
            ...
            var MasterTable = $('.MasterTable').DataTable({
                ...
                ajax: "{{ route('IPDietChartId.dietcharts', ['id' => $id]) }}",
                columns: [
           ...
           let DietList = [];
            ...
            //         var DietChartIpNo = $('#ip_no').val();
            //         var DietChartConNo = $('#consult_no').val();
            //         var DietChartDate = $('#date').val();
            //         var DietChartTime = $('#time').val();
            //         var DietChartDietId = $('#diet').val().join();
            //         var selectize = $('.dietselect')[0].selectize;
            ...
            //             },
            //             data: {
            //                 ip_no_id: DietChartIpNo,
            //                 consultation_id: DietChartConNo,
            //                 date: DietChartDate,
            //                 time: DietChartTime,
            //                 diet_id: DietChartDietId
            //             },
            //             beforeSend: function() {
            //                 $('.loader').show();
            //                 $('#ResponseImage').html("");
            ...
            $('#MasterTable').on('click', '.btn_edit', function () {
                ...
                $.ajax(settings).done(function (response) {
                    ...
                    if (Dietchartedit.success == true) {
                        ...
                        $("#update_ip_no").val(DietIpNo).change();
                        $("#update_consult_no").val(DietConNo).change();
