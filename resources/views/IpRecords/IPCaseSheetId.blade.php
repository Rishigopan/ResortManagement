    ...
    <body>
        ...
        <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="morningshedulecanvas" aria-labelledby="offcanvasWithBothOptionsLabel">
            <div class="offcanvas-header">
                <h5 class="offcanvas-title" id="offcanvasWithBothOptionsLabel">Therapist Schedule</h5>
        ...
        <main id="main" class="main">
            ...
            <div class="container-fluid">
                <h4 class="d-flex justify-content-center py-1 contitle"> IP Case Sheet</h4>                                                                  
            </div>                    
            <div class="wrapper">
                <!--CONTENTS-->
                <div class="container-fluid mainContents">
                    <form id="case_sheet" class="AddForm">                                                                 
                        <div class="row mx-2">
                            ...
                            <div class="col-xl-4 col-lg-4 col-6">
                                ...
                                <select class="form-select inputfield IP_No" aria-label="Default select example name"id="ip_no" name="IPNo" disabled>
                                @foreach ($ipno as $key )   
                            ...
                            <div class="col-xl-4 col-lg-4 col-6">
                                ...
                                <select class="form-select inputfield consult_no" aria-label="Default select example name"id="consult_no" name="ConsultNo" disabled>
                                <option hidden value=""> Choose IP Consultation Number</option>
                                @foreach ($cono as $key ) 
                            ...
                            <div class="col-xl-2 col-lg-2 col-4 mt-4 text-center">
                                <button id="MrngscheduleButton" type="button"  class="btn activebtn px-3"  data-bs-toggle="offcanvas" data-bs-target="#morningshedulecanvas" aria-controls="offcanvasWithBothOptions"> Schedule </button>
                            </div>
                            ...
                            <div class="col-xl-2 col-lg-2 col-4 mt-4 text-center">
                                <button id="EvngscheduleButton" type="button"  class="btn activebtn px-3"  data-bs-toggle="offcanvas" data-bs-target="#morningshedulecanvas" aria-controls="offcanvasWithBothOptions"> Schedule </button>
                            </div>
                    ...
                    <form id="update_case_sheet" class="UpdateForm" style="display: none;">                                                                 
                        <div class="row mx-2">
                            ...
                            <div class="col-xl-4 col-lg-4 col-6">
                                <label class="mb-1 inputlabel">IP Number<span  style="color:red"> *</span></label><br>
                                <select class="form-select inputfield IP_No" aria-label="Default select example name"id="update_ip_no" name="UpdateIPNo" >
                            ...
                            <div class="col-xl-4 col-lg-4 col-6">
                                <label class="mb-1 inputlabel">Consultation Number</label><br>
                                <select class="form-select inputfield consult_no" aria-label="Default select example name"id="update_consult_no" name="UpdateConsultNo" >
                            ...
                            <div class="col-xl-2 col-lg-2 col-4 mt-4 text-center">
                                <button id="UMrngscheduleButton" type="button"  class="btn activebtn px-3"  data-bs-toggle="offcanvas" data-bs-target="#morningshedulecanvas" aria-controls="offcanvasWithBothOptions"> Schedule </button>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-12">
                                <label class="mb-1 inputlabel">Afternoon Session</label><br>
                            ...
                            <div class="col-xl-2 col-lg-2 col-4 mt-4 text-center">
                                <button id="UEvngscheduleButton" type="button"  class="btn activebtn px-3"  data-bs-toggle="offcanvas" data-bs-target="#morningshedulecanvas" aria-controls="offcanvasWithBothOptions"> Schedule </button>
                            </div>
                            <div class="col-xl-12 col-lg-12 col-12">
                                <label class="mb-1 inputlabel">Vital Datas</label><br>
                                <input class="form-control inputfield" id="update_vital_dates" name="UpdateVitalDates" list="vitaldataslist" autofocus>
                                <datalist id="vitaldataslist">
                                    @foreach ($templates as $key ) 
                                        <option value="{{$key->name}}">
                                    @endforeach
        ...
        <script type="text/javascript">
            ...
            var MasterTable = $('.MasterTable').DataTable({
                ...
                ajax: "{{ route('IPCaseSheetId.casesheets', ['id' => $id]) }}",
                columns: [
            ...
            $(document).ready(function() {
                var IpId = $('#ip_no').val();
                var IpGender = $('#ip_no').find(':selected').data('gender');
                loadIp(IpId);
                loadTherapists(IpGender);
                showopdetails(IpId);
            });
                ...
                if (IpNum) {
                    $.ajax({
                        ...
                        success: function(data) {
                            $('.consult_no').empty();
                           if(data) {
                                $('.consult_no').append('<option class="inputlabel" value="' + data.id + '">' + data.ip_consultation_no + '</option>');
                            }
                        },
                        error: function() {
                            // Handle error case
                            $('.consult_no').empty();
                            $('.consult_no').append('<option value="">Error occurred while loading consultations</option>');
                        }
                    });
                } else {
                    $('.consult_no').empty();
            ...
            function loadTherapists(opGender,MorningTherapistId = 0,EveningTherapistId = 0) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('.mrng_therapist').val(MorningTherapistId || "0").change();
                        ...
                        $('.evng_therapist').val(EveningTherapistId || "0").change();
            ...
            document.getElementById('MrngscheduleButton').addEventListener('click', function() {
                ...
                if (selectedMrngTherapist === "0" || selectedMrngTherapist === "") {                    alertMessage.innerHTML = '<div class="alert alert-danger" role="alert">Please select a therapist.</div>';
                    return; 
                } else{
            ...
            document.getElementById('EvngscheduleButton').addEventListener('click', function() {7
                ...
                if (selectedEvngTherapist === "0" || selectedEvngTherapist === "") {                    alertMessage.innerHTML = '<div class="alert alert-danger" role="alert">Please select a therapist.</div>';
                    return; 
                } else{
                    alertMessage.innerHTML = '';
                    // Send AJAX request to check therapist and date combination availability
            ...
            $('#MasterTable').on('click', '.btn_edit', function () {
                ...
                var settings = {
                "url": "/api/ipcasesheet/"+EditCaseSheet+"",
                "method": "GET",
                "timeout": 0,
                };
                ...
                var CaseSheetResult = JSON.stringify(response);
                    ...
                    if (CaseSheetedit.success == true) {
                        ...
                        $("#update_ip_no").val(CaseSheetopno);
            ...
            $("#update_case_sheet").validate({
                ...
                submitHandler: function(form) {
                    ...
                    var UCaseSheetOpNo = $('#update_ip_no').val();
                    ...
                    $.ajax({
                        url: "/api/ipcasesheet/"+UCaseSheetID+"",
                        method: "PUT",
                        timeout: 0,
                        headers: {
                            "Accept": "application/json",
                        ...
                        if (UCaseSheetResultObj.success == true) {
                            if (UCaseSheetResultObj.code == "0") {
                                ...
                                Uselectizeafter.clear();
                                var opId = $('.IP_No').val();
                                var opGender = $('.IP_No').find(':selected').data('gender');
                                loadIp(opId);
             ...
             $('#MasterTable').on('click', '.btn_delete', function () {
                ...
                $('#confirmYes').click(function(){                    
                    ...
                    $.ajax({
                        url: "/api/ipcasesheet/"+DeleteCaseSheet+"",
                        method: "DELETE",
                        timeout: 0,
                        headers: {
                        "Accept": "application/json",
