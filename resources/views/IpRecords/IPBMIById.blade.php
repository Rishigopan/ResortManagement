    ...
    <body>
                    ...
                    <div class="modal-body">
                        <form class="BMI AddForm" id="bmi" novalidate>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-12">
                                    ...
                                    <select class="form-select inputfield IP_No" aria-label="Default select example name"id="ip_no" name="IPNo" required disabled>
                                        @foreach ($ipno as $key )   
                        ...
                        <form class="UpdateBMI UpdateForm" id="update_bmi" style="display: none;" novalidate>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-12">
                                    <label class="mt-3 mb-1 ">Ip Number<span  style="color:red"> *</span></label><br>
                                    <select class="form-select inputfield IP_No" aria-label="Default select example name"id="update_ip_no" name="UpdateIPNo" required>
                                        @foreach ($ipno as $key )   
                                            <option class="inputlabel" value="{{$key->id}}">{{$key->ip_no}} </option>
                                        @endforeach    
                                    </select>
        ...
        <script type="text/javascript">
            ...
            var MasterTable = $('.MasterTable').DataTable({
                ...
                ajax: "{{ route('IPBMIId.BmiId', ['id' => $id]) }}",
                columns: [
            ...
            $('#MasterTable').on('click', '.btn_edit', function () {
                ...
                $.ajax(settings).done(function (response) {
                    ...
                    if (BMIedit.success == true) {
                        ...
                        $("#update_ip_no").val(UpdateBMIIPNo);
