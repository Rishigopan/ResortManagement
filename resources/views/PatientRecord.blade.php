                                ...
                                <div class="row">
                                        <div class="col-xl-6 col-lg-6 col-12">
                                            <div class="12">
                                                ...
                                                <select class="inputfield OpNo SearchAndSelect" aria-label="Default select example name"id="op_no" name="OpNo" required>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-12">
                                            @foreach ($pr as $Patrec )
                                                ...
                                                @if ($Patrec->input_type == 'text')
                                                    <textarea cols="30" rows="3" class="form-control mt-1 inputfield patientrec" id="{{$Patrec->name}}" name="{{$Patrec->name}}" data-records="{{$Patrec->id}}"></textarea>
                                                @endif
                                            @endforeach 
                                        </div>                                                       
                                    </div>  
