    ...
    <body>
                    ...
                    <form id="case_sheet" class="AddForm">                                                        
                        <div class="row mx-2">
                            ...
                            <div class="col-xl-4 col-lg-4 col-6">
                                ...
                                <select class="form-select inputfield IP_No" aria-label="Default select example name"id="ip_no" name="IPNo" >
        ...
        <script type="text/javascript">
            ...
            var MasterTable = $('.MasterTable').DataTable({
                ...
                ajax: "{{ route('IPcasesheet.ipcasesheet') }}",
                columns: [
            ...
            $(document).on('change','.IP_No',(function(){
                var IpId = $(this).val();
                var IpGender = $(this).find(':selected').data('gender');
                loadIp(IpId);
