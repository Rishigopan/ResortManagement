...
<html lang="en">
  ...
  <title>IP Parient Details</title>
  ...
  <body>
        ...
        @include('layouts.ResponseModals') 
            ...
            <div class="container-fluid">
                <h4 class="d-flex justify-content-center py-1 contitle">IP List</h4>
                ...
                var MasterTable = $('.MasterTable').DataTable({
                    ...
                    initComplete: function () {
                        ...
                        .each(function (colIdx) {
                            ...
                            var title = $(cell).text();
                            if (colIdx < api.columns().nodes().length - 4) {
                    ...
                    ajax: "{{ route('IPDetails.Ipdetails') }}",
                    columns: [
                        ...
                        {data: 'ip_patient_record', name: 'ip_patient_record', orderable: false, searchable: false},
                        {data: 'ip_case_sheet', name: 'ip_case_sheet', orderable: false, searchable: false},
                        {data: 'ip_diet_chart', name: 'ip_diet_chart', orderable: false, searchable: false},
                        {data: 'ip_bmi', name: 'ip_bmi', orderable: false, searchable: false},
