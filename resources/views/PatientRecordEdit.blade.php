                                ...
                                <div class="row">
                                        <div class="col-xl-6 col-lg-6 col-12">
                                            <div class="12">
                                                ...
                                                <select class="SearchAndSelect inputfield OpNo" aria-label="Default select example name"id="op_no" name="OpNo" disabled>
                                            @foreach ($opno as $key )   
                ...
                $("#patient_record").validate({
                    submitHandler: function(form) {
                        ...
                        $.ajax({
                            ...
                            location.replace("{{ url('/PatientRecordView') }}")
                        });                               
                    }
                });
            });
