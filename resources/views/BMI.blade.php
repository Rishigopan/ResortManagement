                    ...
                    <div class="modal-body">
                        ...
                        <form class="UpdateBMI UpdateForm" id="update_bmi" style="display: none;" novalidate>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-12">
                                    <label class="mt-3 mb-1 ">Op Number<span  style="color:red"> *</span></label><br>
                                    <select class="SearchAndSelect inputfield op_no" aria-label="Default select example name"id="update_op_no" name="UpdateOPNo" required>
                                        @foreach ($opno as $key )   
                                            <option class="inputlabel" value="{{$key->id}}">{{$key->op_no}} </option>
                                        @endforeach    
                                    </select>
                                ...
                                <div class="col-xl-6 col-lg-6 col-12">
                                    <label class=" mb-1 inputlabel">Morning</label><br>
                                    <input type="number" class="form-control mt-1 inputfield" id="update_temp_mrng" name="UpdateTempMrng" min="0" placeholder="Temperature Morning °F"  >
                                </div>  
                                <div class="col-xl-6 col-lg-6 col-12">
                                    <label class=" mb-1 inputlabel">Evening</label><br>
                                    <input type="number" class="form-control mt-1 inputfield" id="update_temp_evng" name="UpdateTempEvng" min="0" placeholder="Temperature Evening °F"  >
                                </div>  
                    ...
                    <div class="modal-body">
                        <form class="ViewBMI " id="view_bmi" novalidate>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-6 col-12">
                                    <label class=" mb-1 inputlabel">Morning</label><br>
                                    <input type="text" class="form-control mt-1 inputfield" id="view_temp_mrng" name="ViewTempMrng" placeholder="Temperature Morning °F" disabled >
                                </div>  
                                <div class="col-xl-6 col-lg-6 col-12">
                                    <label class=" mb-1 inputlabel">Evening</label><br>
                                    <input type="text" class="form-control mt-1 inputfield" id="view_temp_evng" name="ViewTempEvng" placeholder="Temperature Evening °F" disabled >
                                </div>  
            ...
            $('#MasterTable').on('click', '.btn_edit', function () {
                ...
                $.ajax(settings).done(function (response) {
                    ...
                    if (BMIedit.success == true) {
                        ...
                        $('#update_op_no').data('selectize').setValue(UpdateBMIOPNo);
